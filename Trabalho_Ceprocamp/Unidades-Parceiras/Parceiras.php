                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">O Programa Mão Amiga tem o objetivo promover formação profissional às
                            ...
                            serviços da rede socioassistencial da Prefeitura de Campinas, assim como recebem a
                            oportunidade de qualificação por meio de diversas parcerias com instituições.
                        </p>
                        <a href="maoAmiga" class="btn btn-danger">Ver Mais</a>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">O Centro de Integração da Cidadania (CIC) é um programa da Secretaria
                            ...
                            cursos profissionalizantes, casamentos comunitários, núcleo de mediação de conflitos,
                            orientação ao consumidor pelo Procon-SP, além de acesso à justiça gratuita por meio da
                            Defensoria Pública.
                        </p>
                        <a href="cic" class="btn btn-danger">Ver Mais</a>
                    </div>
                </div>
