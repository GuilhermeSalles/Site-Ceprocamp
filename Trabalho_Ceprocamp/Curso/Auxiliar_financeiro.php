...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-8 col-xs-8" data-anime="left">
            ...
            <ul class="b ml-5">
                <li>Possuir 17 anos completos até o último dia da inscrição.</li>
        ...
        <div class="col-sm-12 col-md-4 col-xs-4">
            ...
            <a href="https://www.instagram.com/p/CP3lR2gLWj2/"><img style="margin-top: 0%;" src="../img/POST INSTA/16.png" class="img-fluid rounded"></a>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="input" class="form-control" id="curso" name="Curso" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" value="Auxiliar Financeiro" readonly>
                                </div>
