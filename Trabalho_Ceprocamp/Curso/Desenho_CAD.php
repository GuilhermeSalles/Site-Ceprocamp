...
<div class="container">
    ...
    <hr class="hr3 mt-0">
    <img style="margin-top: 0%;" src="../img/CAPA PARA CURSO/7.png" class="img-fluid rounded">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-8 col-xs-8" data-anime="left">
            ...
            <ul class="b ml-5">
                ...
                <li>Possuir o pré-requisito exigido para cada curso, de forma a aproveitar totalmente a aprendizagem
                    oferecida.</li>
                <li>8ª Série / 9º Ano do Ensino Fundamental e Conhecimento Em Informática.</li>
            </ul>
        ...
        <div class="col-sm-12 col-md-4 col-xs-4">
            ...
            <a href="https://www.instagram.com/p/CP58TmPrjKJ/"><img style="margin-top: 0%;" src="../img/POST INSTA/7.png" class="img-fluid rounded"></a>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="input" class="form-control" id="curso" name="Curso" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" required value="Desenho Técnico - Autocad" readonly>
                                </div>
