...
<div class="container">
    ...
    <hr class="hr3 mt-0">
    <img style="margin-top: 0%;" src="../img/CAPA PARA CURSO/28.png" class="img-fluid rounded">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-4 col-xs-4">
            ...
            <a href="https://www.instagram.com/p/CP1OOqcLN1C/"><img style="margin-top: 0%;" src="../img/POST INSTA/28.png" class="img-fluid rounded"></a>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="input" class="form-control" id="curso" name="Curso" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" required value="Auxiliar de Almoxarifado" readonly>
                                </div>
        ...
        <div class="col-sm-10 col-md-12 col-xs-12">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row"><a href="../myrian" title="Clique para saber mais sobre o local."  style="color: rgb(75, 75, 75);">Myrian</a></th>
                        <td><img src="../img/Icones dia/x-circle.svg" alt="Turno da aula"> Indisponível</td>
                        <td><img src="../img/Icones dia/x-circle.svg" alt="Turno da aula"> Indisponível</td>
                        <td><img src="../img/Icones dia/check.svg" alt="Turno da aula"> Disponível</td>
                    </tr>
    ...
    <div class="row grande">
        <div class="col-sm-10 col-md-12 col-xs-12">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th colspan="4" class="text-center"><a href="../myrian" title="Clique para saber mais sobre o local."  style="color: rgb(75, 75, 75);">Myrian</a></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
