...
<div class="container">
    ...
    <hr class="hr3 mt-0">
    <img style="margin-top: 0%;" src="../img/CAPA PARA CURSO/16.png" class="img-fluid rounded">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-4 col-xs-4">
            ...
            <a href="https://www.instagram.com/p/CP8hL2yr4OF/"><img style="margin-top: 0%;" src="../img/POST INSTA/16.png" class="img-fluid rounded"></a>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="Nome" name="Nome" placeholder="Nome completo" style="border-radius: 10px;" required required>
                                </div>
                                <div class="form-group">
                                    <label class="bold" for="email">Digite seu e-mail:</label>
                                    <input type="email" class="form-control" id="email" name="Email" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" required required>
                                </div>
                                <div class="form-group">
                                    <label class="bold" for="telefone">Digite seu telefone:</label>
                                    <input type="tel" class="form-control" id="telefone" name="Telefone" aria-describedby="emailHelp" placeholder="(xx) xxxx-xxxx" style="border-radius: 10px;" required required>
                                </div>
                                <div class="form-group">
                                    <label class="bold" for="curso">Curso:</label>
                                    <input type="input" class="form-control" id="curso" name="Curso" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" required required value="Microempreendedor" readonly>
                                </div>

                                <div class="form-group">
                                    <label class="bold" for="unidade">Selecione a unidade mais perto de você:</label>
                                    <select class="form-control" id="unidade" style="border-radius: 10px;" required required name="Unidade">
