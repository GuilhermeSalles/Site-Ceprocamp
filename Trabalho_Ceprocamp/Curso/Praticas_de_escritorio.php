...
<div class="container">
    ...
    <hr class="hr3 mt-0">
    <img style="margin-top: 0%;" src="../img/CAPA PARA CURSO/24.png" class="img-fluid rounded">
...
<div class="container">
    ...
    <p class="text-justify"> Capacita o profissional acerca dos procedimentos administrativos adotados em diversos segmentos no que tange a manipulação e arquivamento de documentos diversos e apresenta novos processos e tecnologias para atuação plena como auxiliar administrativo.
    </p>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-4 col-xs-4">
            ...
            <a href="https://www.instagram.com/p/CP1OOqcLN1C/"><img style="margin-top: 0%;" src="../img/POST INSTA/24.png" class="img-fluid rounded"></a>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="input" class="form-control" id="curso" name="Curso" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" required value="Práticas de Escritório" readonly>
                                </div>
