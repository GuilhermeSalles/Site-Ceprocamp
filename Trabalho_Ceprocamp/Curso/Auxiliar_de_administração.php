<?php include 'header-menu.php' ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-9">
                <h2 style="font-weight: bold; color: #FE5722FF;"> <img class="mb-1"
                        src=" ../img/Icones dia/book.svg">Auxiliar Administrativo</h2>
            </div>
    ...
    <div class="container">
        ...
        <?php include 'texto-inscrever.php' ?>
        ...
        <h6 style="font-weight: bold; color: rgb(75, 75, 75);">Requisitos Específicos:</h6>
            ...
            <div class="col-sm-12 col-md-4 col-xs-4" data-anime="right">
                ...
                <img style="margin-top: 0%;" src="../img/POST INSTA/19.png" class="img-fluid rounded">

                <br>
                <br>

                <h3 class="ml-1" style="font-weight: bold; margin-bottom: 2%;">Registre seu interesse</h3>
                <hr class=" ml-1 hr5Ri">
                <a class="ml-1 bhouver btn btn-danger btn-outline-danger" style="color: white;" href="../Interesse"
                    role="button">Registrar interesse</a>

                <br>
                <br>

                <h3 class="ml-1" style="font-weight: bold; margin-bottom: 2%;">Inscrições</h3>
                <hr class=" ml-1 hr5E">
