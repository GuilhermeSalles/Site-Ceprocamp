                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="input" class="form-control" id="curso" name="Curso" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" required value="Informática Básica" readonly>
                                </div>
