...
<div class="container">
    <div class="row">
        ...
        <div class="col-9">
            <h2 style="font-weight: bold; color: #FE5722FF;"> <img class="mb-1" src=" ../img/Icones dia/book.svg">Português e Matemática para Concursos Públicos e Enem</h2>
        </div>
    ...
    <hr class="hr3 mt-0">
    <img style="margin-top: 0%;" src="../img/CAPA PARA CURSO/50.png" class="img-fluid rounded">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-4 col-xs-4">
            ...
            <a href="https://www.instagram.com/p/CP-4NQlLZHP/"><img style="margin-top: 0%;" src="../img/POST INSTA/50.png" class="img-fluid rounded"></a>
