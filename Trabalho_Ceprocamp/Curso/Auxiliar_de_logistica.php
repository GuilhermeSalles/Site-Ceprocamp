...
<div class="container">
    ...
    <div class="row">
        <div class="col-9">
            <h2 style="font-weight: bold; color: #fe5722; margin-bottom: 5px;"> <img class="mb-1" src=" ../img/Icones dia/book.svg">
                Auxiliar de Logística</h2>
        </div>

        <div class="col-3 mt-2">
            <h6><span style="font-weight: bold; color: #fe5722; margin-bottom: 5px;"> <img src="../img/Icones dia/clock.svg"> Duração:
                </span>200 horas</h6>
        </div>
    ...
    <hr class="hr3 mt-0">
    <img style="margin-top: 0%;" src="../img/CAPA PARA CURSO/27.png" class="img-fluid rounded">
...
<div class="container">
    ...
    <div class="text-center">
        ...
        <h2 style="font-weight: bold; color: #fe5722; margin-bottom: 5px;" class="fw-bolder font-monospace">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-4 col-xs-4">
            ...
            <a href="https://www.instagram.com/p/CP3XiRTL1ko/"><img style="margin-top: 0%;" src="../img/POST INSTA/27.png" class="img-fluid rounded"></a>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="input" class="form-control" id="curso" name="Curso" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" value="Auxiliar de Logística" readonly>
                                </div>
