...
<div class="container">
    ...
    <p class="text-justify"> Capacita o profissional acerca dos procedimentos financeiros adotados em diversos segmentos do mercado e apresenta novos processos e tecnologias para atuação plena como auxiliar financeiro.
    </p>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="input" class="form-control" id="curso" name="Curso" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" required value="Práticas Contábeis" readonly>
                                </div>
