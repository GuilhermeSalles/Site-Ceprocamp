<?php include 'header-menu.php' ?>
    ...
    <div class="container">
        ...
        <hr class="hr3 mt-0">
        <img style="margin-top: 0%;" src="../img/CAPA PARA CURSO/9.png" class="img-fluid rounded">
    </div>
    <br>
    ...
    <div class="container">
            ...
            <div class="row ">
                <p class="fs-5 lh-sm font-monospace text-justify"> Este curso forma profissionais para controlar o fluxo
                    de
                    pessoas e veículos, recepcionar e orientar visitantes em condomínios e empresas.
                </p>
            </div>
        ...
        <div class="row"> 
           ...
           <div class="col-sm-12 col-md-4 col-xs-4">
                ...
                <img style="margin-top: 0%;" src="../img/POST INSTA/9.png" class="img-fluid rounded">
                        ...
                        <div class="modal-body">
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="input" class="form-control" id="curso" name="Curso" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" value="Porteiro Básico" readonly>
                                </div>
        ...
        <div class="row grande">
            <div class="col-sm-10 col-md-12 col-xs-12">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th colspan="4" class="text-center">Casi</th>
