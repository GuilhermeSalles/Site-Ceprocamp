...
<div class="container">
    ...
    <p class="text-justify"> Atendem os clientes, servem alimentos e bebidas em restaurantes , bares, cafeterias, hotéis, hospitais, eventos, etc. Manipulam alimentos e preparam sucos, drinks, e cafés. Realizam serviços de vinho e de café.
    </p>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="input" class="form-control" id="curso" name="Curso" aria-describedby="emailHelp" placeholder="Digite e-mail para contato" style="border-radius: 10px;" required value="Atendimento e Copa" readonly>
                                </div>
