                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="card-deck">
                                    <div class="card m-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="Curso/Agente_de_segurança_do_trabalho_e_higiene_ocupacional"
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-12 text-center mb-4">
                                        <a class="btn btn-danger" href="CursosQualificacao"
                                            role="button">Clique
                        ...
                        <div class="row">
                            <div class="row mb-4">
                                <div class="card-deck">
                                    ...
                                    <div class="card m-3">
                                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/24.png"
                                            alt="Imagem de capa do card">
                                        <div class="card-body">
                                            ...
                                            <a href="Curso/Técnico_em_Logística"
                                                class="btn btn-danger">Ver Mais</a>
                                        </div>
                                        <div class="card-footer">
                                            <small class="text-muted"><b>Período:</b> Noite.
                                    ...
                                    <div class="card m-3">
                                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/23.png"
                                            alt="Imagem de capa do card">
                                        <div class="card-body">
                                            ...
                                            <a href="Curso/Técnico_em_Administração" class="btn btn-danger">Ver
                                                Mais</a>
                                        </div>
                                        <div class="card-footer">
                                    ...
                                    <div class="card m-3">
                                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/25.png"
                                            alt="Imagem de capa do card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">Capacita o aluno para auxiliar na coleta,
                                                ...
                                                redução, reuso e
                                                reciclagem.</p>
                                            <a href="Curso/Técnico_em_Meio _Ambiente" class="btn btn-danger">Ver
                                                Mais</a>
                                        </div>
                                        <div class="card-footer">
                                            <small class="text-muted"><b>Período:</b> Tarde, Noite.
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            ...
                            <span style="font-weight: bold;">E-mail:</span> <a style="color: #fe5722;"
                                href="mailto:fumec.ceprocamp@campinas.sp.gov.br">fumec.ceprocamp@campinas.sp.gov.br</a>
                        ...
                        <div class="col-sm-7">
                            ...
                            <div id="mapf" class="col-sm">
                                <iframe class="map-big"
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1611.6004010871873!2d-47.066509884600116!3d-22.908321123006417!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94c8c8b700170993%3A0x448db64c645985ad!2sCEPROCAMP!5e1!3m2!1spt-BR!2sbr!4v1620853110117!5m2!1spt-BR!2sbr"
