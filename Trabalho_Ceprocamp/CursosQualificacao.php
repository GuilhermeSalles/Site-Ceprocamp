        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12" id="filter-btn-box">
                    <button class="main-btn filter-btn active" style="margin-bottom: 10px; font-weight: bold;"
                        id="all-btn">Todos</button>
                    <button class="main-btn filter-btn" style="margin-bottom: 10px; font-weight: bold;"
                        id="m-btn">Manhã</button>
                    <button class="main-btn filter-btn" style="margin-bottom: 10px; font-weight: bold;"
                        id="t-btn">Tarde</button>
                    <button class="main-btn filter-btn" style="margin-bottom: 10px; font-weight: bold;"
                        id="n-btn">Noite</button>
                    <hr class="filtro">
                </div>

                <div class="col-md-4 project-box m n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/18.png"
                ...
                <div class="col-md-4 project-box n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/16.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m t n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/11.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box t">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/15.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box t">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/14.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/20.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box t">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/22.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box t">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/17.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m t n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/8.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/9.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m t n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/3.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/19.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m t">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/5.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/1.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m t n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/13.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m ">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/21.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box t ">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/12.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/7.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m t">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/2.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/10.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m t n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/4.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                ...
                <div class="col-md-4 project-box m t n">
                    <div class="card">
                        <img class="card-img-top" src="img/CAPA MINIATURA CURSOS/6.png"
                            alt="Imagem de capa do card">
                        <div class="card-body">
                            <h5 class="card-title">INTRODUÇÃO A JOGOS</h5>
                            ...
                            <a href="Curso/Desenvolvimento_de_games"
                                class="btn btn-danger">Ver Mais</a>
                        </div>
                        <div class="card-footer">
