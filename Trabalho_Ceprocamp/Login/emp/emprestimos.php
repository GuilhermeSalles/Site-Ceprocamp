...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="ml-auto">
                <button type="button" class="btn btn-success mr-4" data-toggle="modal" data-target="#cadastrar">Cadastrar</button>
                <!-- Modal Visualizar -->
                ...
                <?php while ($rows_cursos = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal" data-id="<?php echo $rows_cursos['id']; ?>" data-nome="<?php echo $rows_cursos['nomeProfessor']; ?>" data-local="<?php echo $rows_cursos['local']; ?>" data-sala="<?php echo $rows_cursos['sala']; ?>" data-data="<?php echo $rows_cursos['data']; ?>" data-notebooks="<?php echo $rows_cursos['notebooks']; ?>">Editar</button>
                        </td>
                    </tr>
                    <!-- Modal Visualizar -->
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form> <input name="id" type="hidden" id="id">
