            ...
            <div class="collapse navbar-collapse" id="navbarSite">
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php if ($_SESSION['nivel'] == "CPD-OV") { ?>
                        ...
                        <a class="dropdown-item" href="../professores/">Cadastro Professores</a>
                        <a class="dropdown-item" href="../entregadores/">Cadastro Entregadores</a>
                        <a class="dropdown-item" href="../notebooks/">Cadastro Notebooks</a>
                    ...
                    <?php if ($_SESSION['nivel'] == "CPD-OV") { ?>
                        <li class="nav-item">
                            <a class="nav-link" href="../../empOV/excel/planilha">Excel de Emprestimos</a>
                        </li>
                    <?php } ?>
