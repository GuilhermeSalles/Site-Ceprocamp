...
$result_cursos = "SELECT * FROM emprestimoOV order by id DESC";
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php while ($rows = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        <td><?php echo $rows['nomeProfessor']; ?></td>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editar" data-id="<?php echo $rows['id']; ?>" data-nome="<?php echo $rows['nomeProfessor']; ?>" data-local="<?php echo $rows['local']; ?>" data-sala="<?php echo $rows['sala']; ?>" data-data="<?php echo $rows['data']; ?>" data-devolveu="<?php echo $rows['devolveu']; ?>" data-notebooks="<?php echo $rows['notebooks']; ?>">Editar</button>
                        </td>
                    </tr>
                    <!-- Modal Visualizar -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p><span class="bold">Notebooks: </span><?php echo $rows['notebooks']; ?></p>
